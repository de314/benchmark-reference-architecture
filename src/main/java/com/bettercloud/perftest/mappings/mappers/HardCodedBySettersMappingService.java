...
public class HardCodedBySettersMappingService implements MappingService {
    ...
    public PublicAntipatternEntity antipatternToEntity(PublicAntipattern antipattern) {
        ...
        entity.setMyString(antipattern.getMyString());
        entity.setMyInt(antipattern.getMyInt());
        entity.setMyBool(antipattern.isMyBool());
        entity.setMyUuid(antipattern.getMyUuid());
        entity.setMyDate(antipattern.getMyDate());
        return entity;
    }
}
